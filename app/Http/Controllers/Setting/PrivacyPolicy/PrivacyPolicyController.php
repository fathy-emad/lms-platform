...
use App\Http\Repositories\PrivacyPolicyRepository;
use App\Http\Controllers\Setting\PrivacyPolicy\Requests\{CreateRequest, UpdateRequest, DeleteRequest};
...
class PrivacyPolicyController extends Controller
{
    public function __construct(
        ...
        protected PrivacyPolicyRequestHandler $requestHandler,
