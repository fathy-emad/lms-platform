...
namespace App\Http\Controllers\Setting\Enumeration;

use App\Http\Controllers\Controller;
use App\Http\Controllers\Setting\Enumeration\Requests\{UpdateRequest};
use App\Http\Controllers\Setting\Enumeration\Requests\CreateRequest;
