        ...
        <li class="language-nav">
          <div class="translate_wrapper">
            <div class="current_lang">
              ...
              <div class="lang"><i class="flag-icon flag-icon-{{ (session("locale") == 'en') ? 'us' : "eg" }}"></i><span class="lang-txt">{{ session("locale") }} </span></div>
            </div>
            <div class="more_lang">
                <a href="{{ route('lang', 'ar')}}" class="{{ session("locale") == "ar" ? 'active' : ''}}">
                    <div class="lang {{ (session("locale")  == 'ar') ? 'selected' : ''}}" data-value="ar"><i class="flag-icon flag-icon-eg"></i> <span class="lang-txt">لعربية</span> <span> (ar)</span></div>
                </a>
                <a href="{{ route('lang', 'en')}}" class="{{ (session("locale") == 'en') ? 'active' : ''}}">
                    <div class="lang {{ (session("locale")  == 'en') ? 'selected' : ''}}" data-value="en"><i class="flag-icon flag-icon-us"></i> <span class="lang-txt">English</span><span> (US)</span></div>
                </a>
...
{{--        </li>--}}
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            <li><a href="{{ route("admin.account") }}"><i data-feather="user"></i><span>Account </span></a></li>
