...
@section('content')
    <div class="container-fluid">
                    ...
                    <div class="card-header">
                        ...
                        <nav class="breadcrumb breadcrumb-icon">
                            <a class="breadcrumb-item" href=""
                               data-bread="curriculum">({{ __("attributes.curriculum") }})</a>
                            <a class="breadcrumb-item" href="" data-bread="chapter">({{ __("attributes.chapter") }}
                                )</a>
                            <a class="breadcrumb-item" href="" data-bread="lesson">({{ __("attributes.lesson") }}
                                )</a>
                        </nav>
                    </div>
                    <div class="card-body">
        ...
        <!-- Create modal -->
        <div class="modal fade create_modal" aria-labelledby="myLargeModalLabel" style="display: none;"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form novalidate="" class="theme-form needs-validation" id="form1" method="POST"
                              authorization="{{session("teacher_data")["jwtToken"]}}"
                              action="{{ url('api/teacher/bank-question') }}" locale="{{session("locale")}}"
                              csrf="{{ csrf_token()}}">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-primary me-3">
                                                                <input class="form-check-input" id="correctAnswer_A"
                                                                       type="radio" name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="" checked>
                                                                <label class="form-check-label"
                                                                       for="correctAnswer_A"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">A</h6>
                                                                <p><input type="text" name="answers[]"
                                                                          class="form-control" id="answers"
                                                                          data-correctAnswer="A"/></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-secondary me-3">
                                                                <input class="form-check-input" id="correctAnswer_B"
                                                                       type="radio" name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="correctAnswer_B"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">B</h6>
                                                                <div><input type="text" name="answers[]"
                                                                            class="form-control" id="answers"
                                                                            data-correctAnswer="B"/></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-success me-3">
                                                                <input class="form-check-input" id="correctAnswer_C"
                                                                       type="radio" name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="correctAnswer_C"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">C</h6>
                                                                <p><input type="text" name="answers[]"
                                                                          class="form-control" id="answers"
                                                                          data-correctAnswer="C"/></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-warning me-3">
                                                                <input class="form-check-input" id="correctAnswer_D"
                                                                       type="radio" name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="correctAnswer_D"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">D</h6>
                                                                <p><input type="text" name="answers[]"
                                                                          class="form-control" id="answers"
                                                                          data-correctAnswer="D"/></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-sm-12 mb-3 media">
                                        ...
                                        <div class="media-body icon-state">
                                            <label class="switch">
                                                <input type="checkbox" name="ActiveEnum"
                                                       value="{{\App\Enums\ActiveEnum::Active->value}}"><span
                            ...
                            <div class="form-group mb-0">
                                <button class="btn btn-primary btn-block"
                                        onclick="submitForm(this, $('#data-table-ajax'))"
                                        type="button">{{ __("lang.create") }}</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!-- Update modal -->
        <div class="modal fade update_modal" aria-labelledby="myLargeModalLabel" style="display: none;"
             data-bs-backdrop="static" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form novalidate="" class="theme-form needs-validation" id="form2" method="POST"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="hidden" name="teacher_id" value="{{session("teacher_data")["id"]}}">
                                        <input type="hidden" name="lesson_id" value="{{request("lesson_id")}}">
                                        <input type="hidden" name="QuestionTypeEnum"
                                               value="{{ \App\Enums\QuestionTypeEnum::Choose->value }}">
                                    </div>
                                                        ...
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-primary me-3">
                                                                <input class="form-check-input"
                                                                       id="update_correctAnswer_A" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="" checked>
                                                                <label class="form-check-label"
                                                                       for="update_correctAnswer_A"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">A</h6>
                                                                <p><input type="text" name="answers[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-secondary me-3">
                                                                <input class="form-check-input"
                                                                       id="update_correctAnswer_B" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="update_correctAnswer_B"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">B</h6>
                                                                <div><input type="text" name="answers[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-success me-3">
                                                                <input class="form-check-input"
                                                                       id="update_correctAnswer_C" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="update_correctAnswer_C"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">C</h6>
                                                                <p><input type="text" name="answers[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-warning me-3">
                                                                <input class="form-check-input"
                                                                       id="update_correctAnswer_D" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="update_correctAnswer_D"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">D</h6>
                                                                <p><input type="text" name="answers[]"
                            ...
                            <div class="form-group mb-0">
                                <button class="btn btn-primary btn-block"
                                        onclick="submitForm(this, $('#data-table-ajax'))"
                                        type="button">{{ __("lang.update") }}</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!-- View modal -->
        <div class="modal fade view_modal" aria-labelledby="myLargeModalLabel" style="display: none;"
             data-bs-backdrop="static" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-primary me-3">
                                                                <input class="form-check-input"
                                                                       id="view_correctAnswer_A" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="" checked>
                                                                <label class="form-check-label"
                                                                       for="view_correctAnswer_A"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">A</h6>
                                                                <p><input type="text" name="answers[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-secondary me-3">
                                                                <input class="form-check-input"
                                                                       id="view_correctAnswer_B" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="view_correctAnswer_B"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">B</h6>
                                                                <div><input type="text" name="answers[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-success me-3">
                                                                <input class="form-check-input"
                                                                       id="view_correctAnswer_C" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="view_correctAnswer_C"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">C</h6>
                                                                <p><input type="text" name="answers[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="media p-20">
                                                            <div class="form-check radio radio-warning me-3">
                                                                <input class="form-check-input"
                                                                       id="view_correctAnswer_D" type="radio"
                                                                       name="correctAnswer" value=""
                                                                       data-bs-original-title="" title="">
                                                                <label class="form-check-label"
                                                                       for="view_correctAnswer_D"></label>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mt-0 mega-title-badge">D</h6>
                                                                <p><input type="text" name="answers[]"
...
@section('script')
    ...
    <script>
        let datatableUri = `{{ url("api")."/teacher/bank-question?where=teacher_id:" . session("teacher_data")["id"] . ",lesson_id:" . request('lesson_id')}}`;
                ...
                "render": function (data, type, row, meta) {
                    ...
                    actions += `<div class="col-auto">
                                <button class="btn btn-sm btn-warning" type="button" onclick="openModalUpdate(${dataString})"
                                        data-bs-original-title="{{ __('lang.update') }} Bank Question"
                                        title="{{ __('lang.update') }} Bank Question">
                    ...
                    actions += `<div class="col-auto">
                                <button class="btn btn-sm btn-primary" type="button" onclick="openModalView(${dataString})"
                                        data-bs-original-title="{{ __('lang.view') }} Bank Question"
                                        title="{{ __('lang.view') }} Bank Question">
                                    <i class="fa fa-eye"></i>
                                </button>
                            </div>`;
                    ...
                    if (meta.row === 0) {
                        ...
                        $("[data-bread=chapter]").text("({{ __("attributes.chapter") }}) " + data.lesson.chapter.chapter.translate).attr("href", APP_URL + "/" + "admin/teacher/bank-question/{{request("teacher")}}/{{request("teacher_id")."bank-question.blade.php/".request("curriculum_id")}}");
                        $("[data-bread=lesson]").text("({{ __("attributes.lesson") }}) " + data.lesson.lesson.translate).attr("href", APP_URL + "/" + "admin/teacher/bank-question/{{request("teacher")}}/{{request("teacher_id")."bank-question.blade.php/".request("curriculum_id")."/".request("chapter_id")}}");
                    }
                    return actions;
                }
            }
