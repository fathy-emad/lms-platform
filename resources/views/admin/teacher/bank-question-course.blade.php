            ...
            { "data": "updated_at.dateTime" },
            {
                ...
                "render": function (data) {
                    ...
                    actions += `<div class="col-auto">
                                    <a class="btn btn-sm btn-success" type="button" href="{{url("/admin/teacher/bank-question/" . request("teacher_id"))}}/${data.curriculum.id}">
                                        <i class="fa fa-home"></i> Chapters
                                    </a>
                                </div>`;
                    actions += `</div>`;
                    $("[data-bread=teacher]").text(data.teacher.name).attr("href", APP_URL + "/" + "admin/teacher/bank-question");
                    return actions;
                }
            }
        ];
