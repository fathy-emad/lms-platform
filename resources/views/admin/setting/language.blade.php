...
@section('script')
    ...
    <script>
        ...
        function openModalUpdate(data) {
            ...
            modal.find("[data-file=preview]").attr("src", `${APP_URL}/uploads/${data.flag.file}`);
            modal.find("[data-file=key]").val(data.flag.key);
        ...
        $('.create_modal').on('show.bs.modal', function (e) {
            ...
            form.find(".image-upload-file").find("img").attr("src", "{{asset("assets/images/no-image.jpg")}}");
