                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <ul class="nav nav-pills nav-info mb-3" id="pills-infotab" role="tablist">
                                            ...
                                            <li class="nav-item"><a class="nav-link" id="update-questio-translate-tab" data-bs-toggle="pill" href="#update-question-translate" role="tab" aria-controls="update-question-translate" aria-selected="false" data-bs-original-title="" title=""><i class="icofont icofont-contacts"></i>question translates</a></li>
