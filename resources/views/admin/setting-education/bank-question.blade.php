...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //Get lesson
            $.ajax({
                url: APP_URL + "/api/admin/setting-education/lesson?id={{request("lesson_id")}}",
                type: "GET",
                data: null,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    ...
                    $("[data-bread=country]").text(data.chapter.curriculum.subject.year.stage.country.country.translate).attr("href", APP_URL + "/" + "admin/setting-education/stage");
                    $("[data-bread=stage]").text(data.chapter.curriculum.subject.year.stage.stage.translate).attr("href", APP_URL + "/" + "admin/setting-education/stage");
                    $("[data-bread=year]").text(data.chapter.curriculum.subject.year.year.translate).attr("href", APP_URL + "/" + "admin/setting-education/year/" + data.chapter.curriculum.subject.year.stage.id);
                    $("[data-bread=subject]").text(data.chapter.curriculum.subject.subject.translate).attr("href", APP_URL + "/" + "admin/setting-education/subject/" + data.chapter.curriculum.subject.year.id);
                    $("[data-bread=curriculum]").text(data.chapter.curriculum.curriculum.translate).attr("href", APP_URL + "/" + "admin/setting-education/curriculum/" + data.chapter.curriculum.subject.id);
                    $("[data-bread=chapter]").text(data.chapter.chapter.translate).attr("href", APP_URL + "/" + "admin/setting-education/chapter/" + data.chapter.curriculum.id);
                    $("[data-bread=lesson]").text(data.lesson.translate).attr("href", APP_URL + "/" + "admin/setting-education/lesson/" + data.chapter.id);
                },
